   ...
   public class Auto
    {
        ...
        public virtual Propietario fkpropietarios { get; set; }
        public Auto()
        {
            this.aStatus = true;
        }
        ...
        public void Guardar(Auto nAuto)
        {
            try
            {
                using (var ctx = new DataModel())
        ...
        public static List<Auto> BuscarporID(int pkAuto)
        {
            try
            {
                using (var ctx = new DataModel())
                {
                    return ctx.autos.Where(r => r.pkAuto == pkAuto).ToList();
                }
            }
            catch (Exception)
            {
